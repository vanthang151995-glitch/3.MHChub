...
async function migrate() {
  const pool = mysql.createPool({
    host: process.env.MHCHUB_MYSQL_HOST || "127.0.0.1",
    port: Number(process.env.MHCHUB_MYSQL_PORT) || 3308,
    user: process.env.MHCHUB_MYSQL_USER || "root",
    password: process.env.MHCHUB_MYSQL_PASSWORD || "",
    database: process.env.MHCHUB_MYSQL_DATABASE || "mhchub",
